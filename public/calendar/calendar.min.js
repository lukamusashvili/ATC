!(function (s) {
  ...
  function i(t, e) {
    ...
    if (1 === e) {
      ...
      if (g < 6)
        for (; 0 <= g; g--) {
          var d = new Date(t.getFullYear(), t.getMonth() - 1, i - g);
          r.push(d);
        }
      for (var u = 7 - r.length, h = 0; h < u; h++) {
        d = new Date(a.getFullYear(), a.getMonth(), s + h);
        r.push(d);
      }
    } else
      for (var f = 7 * (e - (l < 0 ? 2 : 1)) - l, y = 1; y <= 7; y++)
        (d =
          f + y <= o
        ...
        : ((a += '<div class="weeks-container">'),
          ...
          (a += (function () {
            ...
            (e +=
              ...
              '" data-week-no="0">'),
            settings.dayMap))
              settings.dayMap.hasOwnProperty(t) &&
                (e +=
                  '<div class="day header" data-day="' +
                  t +
                  '">' +
                  ("function" == typeof settings.formatWeekDay
                    ? settings.formatWeekDay(t)
                    : settings.dayMap[t].substring(0, settings.weekDayLength)) +
                  "</div>");
            return (e += "</div>"), (e += "</div>");
          })()),
          (a +=
            ...
            t.forEach(function (t, e) {
              (r +=
                ...
                t.forEach(function (t, e) {
                  var n = !1,
                    n = (n = t.getMonth() !== i.getMonth() ? !0 : n)
                      ? " disabled"
                      : "",
                    a = !1,
                    a = c && (t == c.toString() || a) ? " selected" : "",
                    s = !1,
        ...
        settings.enableMonthChange &&
          ...
          o
            ...
            .on("click", ".months-container .month", function (t) {
              var e = s(this),
                ...
                e = e.data("year"),
                n = new Date(e, n - 1, 1);
              settings.onChangeMonth(n), (g = !1), d((a = n));
            }),
          o
          ...
          o
            ...
            .on("change", ".months-container .year-dropdown", function (t) {
              var e = s(this).val();
              (a = new Date(e, 0, 1)), settings.onSelectYear(a), d(a);
            })),
        settings.showTodayButton &&
          o
            ...
            .on("click", ".today-button", function (t) {
              (c = a = l),
                settings.onClickToday(l),
                settings.onClickDate(l),
                (g = !1),
                d(a);
            }),
