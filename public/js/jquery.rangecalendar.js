...
$.fn.rangeCalendar = function(options) {
	...
	this.each(function(i, el) {
		...
		obj._generateView = function () {
			...
			obj.monthsObj = $(
        '<div class="wrapper my-wrapper" >Choose date<div class="months"></div> </div><div class="last-update">Last website update: <div style="font-weight:900; padding-left:5px;"> Today</div></div> <div class="choose-time"> <div class="choose-time-div">Choose Time: <div style="color: #0083f8;">Last  week</div> </div><div>24/11/2021</div></div>'
      );
			...
			obj.calendarObj = $(
        '<div class="wrapper">  <div class="calendar"></div> </div>'
